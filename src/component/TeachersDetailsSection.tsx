  ...
  return (
    <div className='bg-[#FAFAFA]'>
      <div className='mx-auto max-w-7xl py-8'>
        ...
        <div className='text-[#1E242C] text-center max-w-md mx-auto text-5xl leading-tight font-semibold'>Discover the Emerging Masters</div>
      ...
      <div className="mx-auto max-w-7xl pt-5 pb-20 flex flex-wrap gap-6">

    ...
    <div className='container max-w-7xl mx-auto px-4 py-8 md:py-12 lg:py-10'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className='max-w-lg mx-auto relative'>
          ...
          <p className='text-customgray mb-5'>Welcome to Global Learner Den, where we believe every student has the potential to shine. More than just a coaching centre, we are a community dedicated to nurturing confidence, resilience, and a lifelong love for learning.

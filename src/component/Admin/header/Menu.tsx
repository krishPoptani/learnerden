        ...
        {menu?.superadmin?.map((item, index) => (
          <div key={index} className="relative cursor-pointer group">
            <div className="flex flex-col items-center">
              ...
              {/* Dropdown on hover */}
              {item?.submenu && (
                <div className="absolute top-[30px] left-1/2 -translate-x-1/2 w-[230px] z-10 rounded-[6px] bg-white shadow-md overflow-hidden transition-all duration-300 ease-in-out group-hover:max-h-[500px]">
